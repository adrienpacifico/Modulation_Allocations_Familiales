...
from modulation_allocations_familiales.reforms import Non_reforme_AFetBaisseQf2012
from openfisca_france.tests import base


def test_non_plaf_qf():
    year = 2014
    reform = Non_reforme_AFetBaisseQf2012.build_reform(base.tax_benefit_system)
