...
def dataframe_result(nb_enf = 5, nb_year_of_simulation = 20):
    import time
...
def dataframe_result_taux(nb_enf = 5, nb_year_of_simulation = 20):
    import time
...
#    print perte_reelle()
    ...
    nb_year_of_simulation = 1

    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result(nb_enf = 1, nb_year_of_simulation =  nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result(nb_enf = 2, nb_year_of_simulation =  nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result(nb_enf = 3, nb_year_of_simulation =  nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result(nb_enf = 4, nb_year_of_simulation =  nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result(nb_enf = 5, nb_year_of_simulation =  nb_year_of_simulation)
##
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result_taux(nb_enf = 1, nb_year_of_simulation = nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result_taux(nb_enf = 2, nb_year_of_simulation = nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result_taux(nb_enf = 3, nb_year_of_simulation = nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result_taux(nb_enf = 4, nb_year_of_simulation = nb_year_of_simulation)
    dataframe1, dataframe2, life_cycle_impact, impact = dataframe_result_taux(nb_enf = 5, nb_year_of_simulation = nb_year_of_simulation)
